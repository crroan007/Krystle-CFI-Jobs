 ...
 * Uses Chromium headless to render HTML and produce a clean, ATS-parseable PDF.
 */
...
async function generatePDF() {
  ...
  let inputPath, outputPath, format = 'letter'; // Default to US Letter for aviation resumes
  ...
  // Resolve font paths relative to project fonts/ directory
